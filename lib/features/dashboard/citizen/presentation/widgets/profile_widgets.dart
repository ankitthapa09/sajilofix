...
class ProfileSettingsMenuCard extends StatelessWidget {
  final int tabIndex;
  final ValueChanged<int> onTabChanged;

  const ProfileSettingsMenuCard({
    super.key,
...
class ProfileBottomSheetOption extends StatelessWidget {
  final IconData icon;
  final String label;
  final VoidCallback onTap;

  const ProfileBottomSheetOption({
    super.key,
    required this.icon,
    required this.label,
    required this.onTap,
