...
//       showMySnackBar(
//         context: context,
//         message: serverMessage ?? e.message ?? 'Failed to upload photo.',
//         isError: true,
...
//       showMySnackBar(
//         context: context,
//         message: serverMessage ?? e.message ?? 'Failed to update profile.',
//         isError: true,
//         icon: Icons.error_outline,
//       );
//     } catch (e) {
...
//             child: photoBytes == null && (photoUrl ?? '').trim().isEmpty
//                 ? Text(
