...
class MyReportHeader extends StatelessWidget {
  final bool isDark;
  const MyReportHeader({super.key, required this.isDark});
...
class MyReportStatsRow extends StatelessWidget {
  final Map<String, int> counts;
  final bool isDark;

  const MyReportStatsRow({
    super.key,
...
class MyReportStatChip extends StatelessWidget {
  final String label;
  final int value;
  final Color color;
  final bool isDark;

  const MyReportStatChip({
    super.key,
    required this.label,
    required this.value,
    required this.color,
...
class MyReportSearchField extends StatelessWidget {
  final TextEditingController controller;
  final bool isDark;

  const MyReportSearchField({
    super.key,
...
class MyReportFilterTabs extends StatelessWidget {
  final Map<String, int> counts;
  final String selected;
  final ValueChanged<String> onSelected;

  const MyReportFilterTabs({
    super.key,
    required this.counts,
...
class MyReportChip extends StatelessWidget {
  final String label;
  final Color color;
  final Color bg;
...
class MyReportEmptyState extends StatelessWidget {
  final VoidCallback onRefresh;
  const MyReportEmptyState({super.key, required this.onRefresh});
...
class MyReportErrorState extends StatelessWidget {
  final String message;
  final VoidCallback onRetry;
  const MyReportErrorState({
    super.key,
